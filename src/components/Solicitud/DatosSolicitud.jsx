...
function DatosSolicitud({ setResponse }) {
  ...
  const handleSelectUnidad = (data) => {
    if (data.gestoria && data.gestoria.selectedCliente) {
      setValue(
        "trazabilidad",
        data.trazabilidad
          .toString()
      ...
      setResponse({
        message: (
          <>
            <p>No hay datos de <strong>Gestoría o Cliente</strong>   en la unidad seleccionada.</p>
            <p>Verifica lo siguiente en el registro de Gestoría (REG-CO-0088):</p>
            <ul className="list-disc list-inside">
              <li>La trazabiliad esta agregada</li>
              <li>La trazabiliad tiene un id de cliente</li>
              <li>El id de cliente es correcto</li>
              <li>La trazabilidad tiene <strong>formato correcto</strong> (sin guiones o puntos)</li>
            </ul>
          </>
        ),
        type: "danger",
